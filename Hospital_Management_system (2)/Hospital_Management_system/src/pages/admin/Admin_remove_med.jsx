...
const Admin_remove_med = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(`http://localhost:5000/delete-med-dept/${medId}`, {
        method: 'DELETE'
      });
    ...
    <div className='admin-remove-container'>
      ...
      <div>
        <form className='admin-remove-doc' onSubmit={handleSubmit}>
          ...
          <input 
            placeholder='   Enter Med Dept ID to Remove...'
            value={medId}
            onChange={(e) => setMedId(e.target.value)}
            required
          />

          <button type='submit'>Remove Medicine Dept</button>
...
export default Admin_remove_med