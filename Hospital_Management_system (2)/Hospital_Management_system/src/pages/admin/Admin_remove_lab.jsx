...
const Admin_remove_lab = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(`http://localhost:5000/delete-lab-tech/${labId}`, {
        method: 'DELETE'
      });
    ...
    <div className='admin-doc-add-container'>
      ...
      <div>
        <form className='admin-remove-doc' onSubmit={handleSubmit}>
          ...
          <input 
            placeholder='   Enter Lab Tech ID to Remove...'
            value={labId}
            onChange={(e) => setLabId(e.target.value)}
            required
          />

          <button type='submit'>Remove Lab Tech</button>
...
export default Admin_remove_lab